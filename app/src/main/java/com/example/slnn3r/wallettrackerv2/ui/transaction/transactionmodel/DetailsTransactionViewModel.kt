...
class DetailsTransactionViewModel : TransactionModelInterface.DetailsTransactionViewModel {
    ...
    override fun editTransactionRealm(mContext: Context, transactionData: Transaction) {
        val realm: Realm
        Realm.init(mContext)
    ...
    override fun deleteTransactionRealm(mContext: Context, transactionId: String?) {
        val realm: Realm
        Realm.init(mContext)
